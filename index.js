...
const ROAST_MATRIX = [
    ...
    "<@${ownerId}>，剛剛有個不長眼的 ${target} 在那邊衝三小，我順手把他 Ban 了，爽！",
    ...
    "<@${ownerId}>，這個 ${target} 剛才在那邊亂噴訊息，我已經送他去投胎了啦。",
    ...
    "這隻 ${target} 剛在那邊跳，我直接一巴掌把他拍到封鎖名單底部，爽啦。",
    ...
    "嘿 <@${ownerId}>，有個智障 ${target} 踩到雷，現在已經是具(被封鎖)屍體了。",
    "這年頭還有人用這麼破的手段？${target} 你回去練練再回來啦，操。",
    "老大，解決掉一個想搞事的 ${target}，現在太平了，請指示！",
    "剛抓到 ${target} 在這亂，我直接送他一張單程票，爽爆！"
];
